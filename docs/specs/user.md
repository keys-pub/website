...
3. Save a signed statement in the key's sigchain ([PUT /sigchain/:kid/:seq](/docs/webapi/sigchain.md#put-sigchain-kid-seq)) including name, service, key identifier and url from step 2.
